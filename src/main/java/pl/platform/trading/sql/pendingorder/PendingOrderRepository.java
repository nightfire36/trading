...
public interface PendingOrderRepository extends JpaRepository<PendingOrder, Long> {
    ...
    public List<PendingOrder> findByCurrencyPairAndOrderPriceGreaterThanAndTriggeredAboveAndLongPosition(
            String currencyPair, BigDecimal orderPrice, boolean triggeredAbove, boolean longPosition);

    public List<PendingOrder> findByCurrencyPairAndOrderPriceLessThanAndTriggeredAboveAndLongPosition(
            String currencyPair, BigDecimal orderPrice, boolean triggeredAbove, boolean longPosition);
